...
export const MY_LATEST_ORDERS_REQUEST = 'MY_LATEST_ORDERS_REQUEST'
export const MY_LATEST_ORDERS_SUCCESS = 'MY_LATEST_ORDERS_SUCCESS'
export const MY_LATEST_ORDERS_FAIL = 'MY_LATEST_ORDERS_FAIL'
